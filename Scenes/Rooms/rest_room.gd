extends Node2D
## Rest zone room. Self-contained scene with walls, floor, ceiling,
## shop items, gem crate, weapon pickup, and exit door.
## Background and decorations are randomized on _ready().
